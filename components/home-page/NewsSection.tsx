    ...
    <section className="py-16 bg-lavender">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Featured YouTube Video with Dr. Susan Gitau info and CTA */}
          <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
            <div className="relative aspect-video">
              <iframe
                className="w-full h-full"
                src="https://www.youtube.com/embed/63CvxPVPMTs?autoplay=1&mute=1&loop=1&playlist=63CvxPVPMTs&controls=1&playsinline=1&modestbranding=1&rel=0"
                title="Africana College Video"
            ...
            <div className="p-5 flex flex-col gap-3">
              ...
              <div className="border-t border-gray-200 pt-3 flex flex-col gap-2">
                ...
                <Link
                  href="/about"
                  className="mt-3 inline-block bg-primary text-white hover:bg-primary/90 px-5 py-2 rounded-full font-medium transition-colors"
                >
                  Learn More
                </Link>
              </div>
